...
Required notices for the bundled third-party binaries are listed in [`licenses/README.md`](licenses/README.md).
...
- `phpsdk_sbom`      - generate and export compliance files for a PHP binary distribution
...
- `cd c:\php-sdk`
- `git checkout php-sdk-2.8.4` or later
